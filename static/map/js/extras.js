// load custom image then use as a symbol
...
// large data file with mixed geometry types
...
function reInit() {
  if (!bricklayer) {
    var imgArr = document.querySelectorAll('.bricklayer img');
    img(imgArr);
...
// image fly to settings

var images = document.querySelectorAll('.bricklayer img');
var assortments = document.getElementById('assortment-target');
for (var i = 0; i < images.length; i++) {
  images[i].addEventListener('click', e => {
    assortments.innerText = e.target.getAttribute('data-pos');
    map.flyTo({
      center: JSON.parse(e.target.getAttribute('data-pos')), 
      zoom: 12.5,
      speed: 0.3,
      curve: 0.8,
